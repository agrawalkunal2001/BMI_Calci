import 'package:bmi_calci/input_page/card_title.dart';
import 'package:bmi_calci/input_page/gender/gender_arrow.dart';
import 'package:bmi_calci/input_page/gender/gender_circle.dart';
import 'package:bmi_calci/input_page/gender/gender_icon.dart';
import 'package:bmi_calci/input_page/gender/gender_styles.dart';
import 'package:bmi_calci/gender.dart';
import 'package:bmi_calci/widget_utils.dart' show screenAwareSize;
...
class TapHandler extends StatelessWidget {
  ...
  const TapHandler({required this.onGenderTapped});
